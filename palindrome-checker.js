...
function palindrome(str) {
    ...
    // Convert string into array, and produce a reversed array to compare the two
    const strArray = str.split("");
    const reversed = strArray
      .slice()
      .reverse();
  
    // Compare the arrays
    return strArray.every((char, index) => {
      const reversedChar = reversed[index];
